...
const selectedProduct = {
  ...
  price: 120,
  OriginalPrice: 150,
  discription: "This is a stylish jackect perfect for any ocassion",
  brand: "Levis",
  material: "Leather",
  sizes: ["XS", "S", "M", "L", "XL"],
  colors: ["Red", "Black"],
...
const ProductDetails = () => {
  const [mainImage, setMainImage] = useState(selectedProduct.images[0].url); // "" inside useState
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:ml-10">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center spac-x-4 mt-2">
                <button
                ...
                <span className="text-lg p-2">{quantity}</span>
                <button
